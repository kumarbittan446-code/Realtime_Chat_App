      ...
      <div className="overflow-y-auto w-full py-3">
        {filteredUser.map((user) => (
          <button
            ...
            className={`w-full p-3 items-center gap-3 hover:bg-base-300 transition-colors ${selectedUser?._id === user._id ? "bg-base-300 ring-1 ring-base-300" : ""}`}
          >
